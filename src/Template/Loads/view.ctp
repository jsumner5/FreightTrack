...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Load'), ['action' => 'edit', $load->Record_ID]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Load'), ['action' => 'delete', $load->Record_ID], ['confirm' => __('Are you sure you want to delete # {0}?', $load->Record_ID)]) ?> </li>
...
<div class="loads view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($load->Record_ID) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Related Company') ?></th>
            <td><?= $this->Number->format($load->Related_Company) ?></td>
        </tr>
    </table>
</div>
